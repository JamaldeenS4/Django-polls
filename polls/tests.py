...
class QuestionIndexViewTests(TestCase):
    """
    view should not return questions that their pub_date is in the future
    """
    ...
    def test_future_question(self):
        ...
        response = self.client.get(reverse("polls:index"))
        self.assertEqual(response.context["latest_question_list"].count(), 0)
        self.assertQuerySetEqual(response.context["latest_question_list"], [])
...
class QuestionDetailViewTests(TestCase):
    """
    view should not show questionsm that their pub_date is in the future
    """
    def test_future_question(self):
        """
        view should not return future question
        """
    ...
    def test_past_question(self):
        """
        view should return past questions
        """
        question = create_question(question_text="past question", days=-30)
        response = self.client.get(reverse("polls:detail", args=(question.id,)))
